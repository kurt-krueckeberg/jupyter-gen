...
```{note}
The **"n"** on "Schäkeln" may be a inflected ending appended to the actual name
("Schäkel").
```

```{list-table} Infant Johanna Sophie Charlotte Krückeberg’s Family
:header-rows: 1
...
* - Name
  - Residence
* - Johanna Sophie Margdelena Wilkening
  - Hockers Aue
* - Sophie Charlotte Rösener
  - Petzen
```
