...
```{list-table} 1792 Philippine Caroline Christine Kruckeberg Baptism
:header-rows: 1
...
* - the old Krückeberg as grandmother
  - 
* - Fahlsing wife of the shepherd
    in Evesen
  - Evesen
```

```{list-table} Nachträge for Philippine Caroline Christine Kruckeberg
:header-rows: 1
...
This entry appears on [image 55, page 105](#PET-B-1792a) of Petzen Kirchenbuch volume 2.
...
```{important}
The residence number **10** was apparently written as 10, perhaps because there was not enough room to write **10**?
...
gest. 26.10.70       geb. Tegtmeyern erzeugte und d. 1ten ejusd abends 6 Uhr
                 ...
                 1. die alte Krückebergen als Großmutter
...
(PET-B-1792a)=
"Archion Protestant Kirchenbücher Portal", database with images, *Archion* ([http:.md](http://www.archion.de/p/75e10a88e0/) : 17 October 2023), path: Niedersachsen > Niedersächsisches Landesarchiv > Kirchenbücher der Evangelisch-Lutherischen
