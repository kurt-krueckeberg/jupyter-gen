...
The birth of a stillborn daughter of Heinrich Wilhelm Weiland is entry 17 on <<PET-B-1815a, image 133, pages 260-261>>.

== Image, Transliteration and Translation

image::petzen-band2-img133.jpg[title="Stillborn daughter of Friedrich Wilhelm Weiland entry 1 (Click to enlarge)",link=self]
