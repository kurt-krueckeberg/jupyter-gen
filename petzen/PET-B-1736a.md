...
The baptism entry is found on [image 152](PET-B-1736a)
...
```{note}
- If the two characters following "v. [von=of, from]" are two B’s, we
assume they are abbreviations for Berenbusch.
