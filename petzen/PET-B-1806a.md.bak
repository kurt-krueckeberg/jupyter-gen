...
```{list-table} Child Johann Heinrich Krückeberg Facts
:header-rows: 1
...
```{list-table} Father Jobst Heinrich Krückeberg Facts
:header-rows: 1
...
```{list-table} Mother Christine Phlippine Lenore Tegtmeier Facts
:header-rows: 1
...
(PET-B-1806a)=
"Archion Protestant Kirchenbücher Portal", database with images, *Archion* ([http:a4feffd4c0](http://www.archion.de/p/a4feffd4c0) : 10 October 2023), path:
