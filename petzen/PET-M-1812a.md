...
* - 
  ...
  - Religion
* - **Groom**
  - Friedrich Wilhelm Raulfing
  - No. 13 Bärenbusch
    (assumed. See note)
  - 23
  - Lutheran
* - **Bride**
  - Maria Philippine Krückeberg
  - no. 10 Bärenbusch
    (assumed. See Note)
  - 18
  - Lutheran
* - **Groom’s Father**
  - Albert Raulfing (deceased)
  - No. 13 Bärenbusch
  - 
  - 
* - **Bride’s Father**
...
```{list-table} Nachträge for Groom Friedrich Wilhelm Raulfing
:header-rows: 1
...
```{list-table} Nachträge for Bride Marie Philippine Krückeberg
:header-rows: 1
...
```{list-table} Facts for Groom Friedrich Wilhelm Raulfing’s Father
:header-rows: 1
...
```{list-table} Facts for Bride Marie Philippine Krückeberg’s Father
:header-rows: 1
