...
The confirmation is found on [image 310](#PET-C-1755b) of the Petzen
...
```{list-table} 1755 Confirmation Sophie Maria Krückeberg from Berenbusch
:header-rows: 1
...
```{list-table} 1756 Confirmation entry 5 of Johann Heinrich Krückeberg from Berenbsuch
:header-rows: 1
